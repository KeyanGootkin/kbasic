...
ansi = {"BLACK": u"\033[0;30m","RED": u"\x1b[0;31m","GREEN": u"\033[0;32m","YELLOW": u"\033[0;33m","BLUE": u"\033[0;34m","PURPLE": u"\033[0;35m","CYAN": u"\033[0;36m","WHITE": u"\033[0;37m",
    "FAINT": u"\033[2m","FAINT BLACK": u"\033[2;30m","FAINT RED": u"\x1b[2;31m","FAINT GREEN": u"\033[2;32m","FAINT YELLOW": u"\033[2;33m","FAINT BLUE": u"\033[2;34m","FAINT PURPLE": u"\033[2;35m","FAINT CYAN": u"\033[2;36m","FAINT WHITE": u"\033[2;37m",
...
# >-|===|>                            Functions                            <|===|-<
# !==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==!==
def color(text: str, color: str = 'white', option: str = '') -> str:
    match option.lower():
        case '': fmt = ansi[color.upper()] 
        case 'faint'|'thin': fmt = ansi[f"FAINT {color.upper()}"]
...
def warn(text: str): print(color(text, 'yellow'))
